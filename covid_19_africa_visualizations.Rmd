...
(latest_confirmed <- latest %>%
                ...
                labs(title = "Africa's Confirmed COVID-19 cases by Country. 2020/04/29"))
```
...
(latest_deaths <- latest %>%
                ...
                # specifying the plot title
                labs(title = "Africa's Deaths from COVID-19 by Country. 2020/04/29"))
...
(latest_recovered <- latest %>%
                ...
                # specifying the plot title
                labs(title = "Africa's Recovered cases from COVID-19 by Country. 2020/04/29"))
```
...
(latest_active <- latest %>%
                ...
                # specifying the plot title
                labs(title = "Africa's Active cases of COVID-19 by Country. 2020/04/29"))
```
