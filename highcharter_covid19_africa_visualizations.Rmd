...
```
At the time of updating this script, all the 54 African countries recognized by the UN and WHO had confirmed cases.

## VISUALIZATIONS OF COVID-19 CASES IN AFRICA
**Interactive plot of changes in the number of COVID-19 cases in Africa**
...
**Interactive plots of COVID-19 cases by African Region.**
...
hchart("line", hcaes(x = ObservationDate, y = Confirmed, group = Region)) %>%
        hc_xAxis(title = list(text = "Date")) %>%
        hc_title(text = "Changes in the number of Confirmed cases by region") %>%
        hc_subtitle(text = today()) %>%
        hc_add_theme(hc_theme_google())
```
...
hchart("line", hcaes(x = ObservationDate, y = Deaths, group = Region)) %>%
        hc_xAxis(title = list(text = "Date")) %>%
        hc_title(text = "Changes in the number of COVID-19 deaths by region") %>%
        hc_subtitle(text = today()) %>%
        hc_add_theme(hc_theme_google())
```

**Interactive plots of the highest to lowest numbers of COVID-19 cases in African countries.**
