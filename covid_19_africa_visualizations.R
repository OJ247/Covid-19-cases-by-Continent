...
(latest_confirmed <- latest %>%
                ...
                labs(title = "Africa's Confirmed Covid-19 cases by Country. 2020-04-28"))
...
(latest_deaths <- latest %>%
                ...
                # specifying the plot title
                labs(title = "Africa's Deaths from Covid-19 by Country. 2020-04-28"))
...
(latest_recovered <- latest %>%
                ...
                # specifying the plot title
                labs(title = "Africa's Recovered cases from covid-19 by Country. 2020-04-28"))
...
(latest_active <- latest %>%
                ...
                # specifying the plot title
                labs(title = "Africa's Active cases of COVID-19 by Country. 2020-04-28"))
