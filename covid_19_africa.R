...
# adding the daily update from John Hopkins University. adjust the name of the csv "05-26-2020.csv" accordingly
daily_update <- read_csv("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports/05-26-2020.csv")
...
# correction on date
daily_update <- daily_update %>%
        mutate(ObservationDate = "2020-05-26") %>%
        mutate(ObservationDate = as_date(ObservationDate))
